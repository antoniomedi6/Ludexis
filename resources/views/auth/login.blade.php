<x-guest-layout>
    <div
        ...
        <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full z-0 opacity-30 dark:opacity-20 pointer-events-none">
            <div
                class="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-cyan-300/50 dark:bg-cyan-900/40 blur-[120px] rounded-full">
            </div>
            <div
                class="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-indigo-300/40 dark:bg-indigo-900/20 blur-[120px] rounded-full">
            </div>
        </div>
            ...
            <div
                ...
                <div class="hidden md:flex flex-col gap-6">
                    ...
                    <h2
                        ...
                        Bienvenido de <span class="text-cyan-600 dark:text-cyan-500">nuevo.</span>
                    </h2>
                    ...
                    <div class="space-y-3 mt-4">
                        <div
                            class="flex items-center gap-3 text-gray-600 dark:text-gray-500 font-bold text-xs uppercase tracking-widest">
                            <div
                                class="size-8 rounded-full bg-cyan-100 dark:bg-cyan-900/30 flex items-center justify-center border border-cyan-300 dark:border-cyan-800/30">
                                <i class="fa-solid fa-gamepad text-cyan-600 dark:text-cyan-500"
                                    aria-hidden="true"></i>
                            </div>
                        ...
                        <div
                            ...
                            <div
                                class="size-8 rounded-full bg-cyan-100 dark:bg-cyan-900/30 flex items-center justify-center border border-cyan-300 dark:border-cyan-800/30">
                                <i class="fa-solid fa-star text-cyan-600 dark:text-cyan-500" aria-hidden="true"></i>
                            </div>
                ...
                <div>
                    ...
                    @session('status')
                        <div class="mb-6 font-bold text-sm text-green-800 dark:text-green-400 bg-green-100 dark:bg-green-900/20 border border-green-300 dark:border-green-800/30 p-4 rounded-xl"
                            role="alert">
                            {{ $value }}
                        </div>
                    @endsession
                    ...
                    <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-5">
                        ...
                        <div class="relative">
                            ...
                            <div class="relative">
                                <i class="fa-solid fa-circle-user absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-500 text-sm"
                                    aria-hidden="true"></i>
                                <x-input id="email"
                        ...
                        <div class="relative">
                            <div class="flex justify-between items-center mb-1 ml-1">
                                <x-label for="password" value="{{ __('Password') }}"
                                    class="text-lightbox-muted dark:text-gray-400 text-[10px] font-black uppercase tracking-widest" />
                            </div>
                            <div class="relative">
                            ...
                            <div class="flex items-center justify-between mt-3 px-1">
                                <label for="remember_me" class="flex items-center cursor-pointer group">
                                    ...
                                    <span
                                        class="ms-2 text-[10px] text-gray-600 dark:text-gray-500 font-bold uppercase tracking-widest group-hover:text-gray-800 dark:group-hover:text-gray-400 transition-colors select-none">
                                        {{ __('Recuérdame') }}
                                    </span>
                                </label>

                                @if (Route::has('password.request'))
                                    <a class="text-[10px] text-cyan-600 dark:text-cyan-500 font-black uppercase tracking-widest hover:text-cyan-500 dark:hover:text-cyan-400 transition-colors"
