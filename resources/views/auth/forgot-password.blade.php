<x-guest-layout>
    <div
        ...
        <div
            class="w-full sm:max-w-md mt-6 px-8 py-10 bg-white dark:bg-[#151821] border border-gray-200 dark:border-gray-800 shadow-xl overflow-hidden rounded-[2rem] transition-colors duration-300">
            ...
            <form method="POST" action="{{ route('password.email') }}" class="flex flex-col gap-4">
                ...
                <div>
                    ...
                    <input id="email"
                        class="w-full bg-gray-100 dark:bg-[#0f1117] border border-gray-200 dark:border-gray-800 text-gray-900 dark:text-white rounded-xl px-4 py-3 text-sm font-bold focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-colors duration-300 shadow-inner block"
