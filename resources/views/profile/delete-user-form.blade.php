                ...
                <div class="mt-4" x-data="{}"
                    ...
                    <div class="relative">
                        ...
                        <x-input type="password"
                            class="mt-1 block w-full sm:w-3/4 bg-lightbox-main dark:bg-darkbox-main border border-lightbox-border dark:border-darkbox-border text-lightbox-text dark:text-white rounded-xl pl-11 pr-4 py-3 text-sm focus:border-red-500 focus:ring-red-500 transition placeholder-gray-400 dark:placeholder-gray-600"
