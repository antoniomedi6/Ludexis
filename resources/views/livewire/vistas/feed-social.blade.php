                                            ...
                                            <div class="flex items-start justify-between gap-2">
                                                <div class="min-w-0 flex-1 flex flex-col gap-1">
                                                    ...
                                                    @if ($item->user->role && $item->user->role !== 'user')
                                                        <span
                                                            class="w-fit text-xs bg-gray-100 dark:bg-darkbox-main text-gray-600 dark:text-gray-300 px-1.5 py-0.5 rounded font-black uppercase tracking-widest"
                                                            aria-label="Rol: {{ $item->user->role }}">
                                                            {{ $item->user->role }}
                                                        </span>
                                                    @endif
                                                </div>
