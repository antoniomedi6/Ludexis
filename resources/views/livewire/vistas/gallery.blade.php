<div
    class="bg-[#0f1117] text-gray-100 font-sans antialiased h-screen overflow-hidden flex selection:bg-cyan-500 selection:text-black">
    <div class="flex-1 flex flex-col overflow-hidden relative">
        <x-miscomponentes.search-header />

        <main class="flex-1 overflow-y-auto p-6 md:p-10 hide-scrollbar">
            <div class="max-w-[1400px] mx-auto flex flex-col gap-10">
                <x-miscomponentes.title title1="Galería de la " title2="Comunidad" />
                    ...
                    <div class="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 2xl:columns-5 gap-6">
                        ...
                        @foreach ($images as $item)
                            <div x-data="{ loaded: false }"
                                ...
                                <img src="{{ Storage::url($item->image_path) }}" @load="loaded = true" x-show="loaded"
                                ...
                                <div x-show="loaded" x-cloak
                                    ...
                                    <div>
                                        <span
                                            ...
                                            {{ $item->game->name ?? 'Juego Desconocido' }}
                                        </span>
