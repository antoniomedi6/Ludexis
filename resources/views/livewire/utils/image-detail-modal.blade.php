            ...
            <div x-show="show" x-transition:enter="transition ease-out duration-300"
                ...
                @if ($image)
                    ...
                    <div
                        ...
                        {{-- HEADER --}}
                        <div
                            class="p-4 pr-12 md:pr-6 md:p-6 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between shrink-0 bg-gray-50/50 dark:bg-[#11131a]">
                        ...
                        <div
                            ...
                            @else
                                <div class="flex flex-col items-center justify-center h-full opacity-50 py-10 md:py-0">
