            ...
            <div x-show="show" x-transition.opacity.duration.200ms style="display: none;" id="search-players-results"
                ...
                @foreach ($players as $player)
                    <button type="button" wire:click="goToProfile({{ $player->id }})" role="option"
                        ...
                        class="w-full text-left flex cursor-pointer items-center gap-3 p-3 hover:bg-lightbox-soft dark:hover:bg-gray-700 focus:bg-lightbox-soft dark:focus:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-cyan-500 transition-colors border-b border-lightbox-border/60 dark:border-gray-700/50 last:border-0 group">
                        ...
                        <div class="flex-1 min-w-0">
                            <h4 class="text-sm font-black text-lightbox-text dark:text-white truncate">
                                {{ $player->name }}
                            </h4>
                        </div>
                    </button>
