<div class="p-6 lg:p-8 bg-lightbox-card border-b border-lightbox-border">
...
<div class="bg-lightbox-soft/60 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
