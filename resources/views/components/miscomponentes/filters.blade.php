    ...
    @if ($orderBy)
        <div class="relative group">
            ...
            <select wire:model.live="orderBy"
                class="bg-lightbox-card dark:bg-darkbox-card border border-lightbox-border dark:border-darkbox-border text-gray-900 dark:text-white text-sm rounded-xl pl-10 pr-10 py-3 font-bold appearance-none cursor-pointer w-full transition-colors shadow-sm">
                {{ $options }}
            </select>
            <i
