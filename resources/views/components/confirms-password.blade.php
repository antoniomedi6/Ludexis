@props([
    ...
    'content' => 'Por seguridad, confirma tu contraseña para continuar.',
    'button' => 'Confirmar',
])
...
<x-dialog-modal wire:model.live="confirmingPassword">
    ...
    <x-slot name="content">
        ...
        <div class="mt-4" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
            <x-input type="password" class="mt-1 block w-3/4" placeholder="Contraseña" autocomplete="current-password"
